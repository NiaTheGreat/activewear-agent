  ...
  return (
    <PageTransition>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">All Manufacturers</h1>
          <p className="text-sm text-gray-500 mt-1">
            Every manufacturer found across all your searches
          </p>
        </div>
        ...
        {isLoading ? (
          ...
          <EmptyState
            ...
            description="Run a search to start finding manufacturers."
            actionLabel="New Search"
            actionHref="/search/new"
          />
        ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Button
                  ...
                  onClick={async () => {
                    try {
                      await api.manufacturers.exportCsv(false);
