...
export function ManufacturerTable({ searchId }: ManufacturerTableProps) {
  ...
  const { data: manufacturers, isLoading } = useManufacturers(searchId, {
    sort_by: sortBy,
    sort_dir: sortDir,
  ...
  if (!manufacturers || manufacturers.length === 0) {
    return (
      <EmptyState
        ...
        description="This search didn't find any manufacturers matching your criteria."
      />
    );
  }
